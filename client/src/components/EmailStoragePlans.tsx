...
const PLANS = [
  ...
  },
  {
    ...
    storage: '25GB',
    price: '£1.99',
    priceId: 'price_email_25gb',
    features: ['25GB email storage', 'All email features', 'Priority support'],
  },
  {
    tier: '50gb' as const,
    name: '50GB Plan',
  ...
  },
  {
    ...
    features: ['Unlimited email storage', 'All premium features', 'Priority support', 'Advanced filters', 'Custom domains', 'API access'],
  },
];
